  ...
  return <Layout title="知识库" description="航天仿真研究知识库入口">
    <AeroLabFrame active="KNOWLEDGE">
      ...
      <section className="lab-page-section">
        <div className="lab-page-head"><div><span>知识轨道</span><h2>专题入口</h2></div><p>视觉入口负责快速理解知识结构，文档细节继续使用 Markdown/MDX 维护。</p></div>
      ...
      <section className="lab-page-section">
        <div className="lab-page-head"><div><span>研究领域</span><h2>研究域沉淀</h2></div><p>每天新增资料先进入情报流，经过判断后再归档到这些研究域。</p></div>
      ...
      <section className="lab-page-section">
        <div className="lab-overlay-panel"><img src={labImages.control} alt="知识库控制台"/><div><span>可维护知识库</span><h3>高级入口，简单维护。</h3><p>视觉入口负责品牌感和导航体验；具体知识仍然用 Markdown/MDX 管理。这样以后你每天新增研究笔记、工具条目、项目评估和实验记录时，不会破坏页面结构。</p></div></div>
      </section>
      <section className="lab-page-section">
        <div className="lab-page-head"><div><span>任务关联</span><h2>任务锚点</h2></div><p>工具、数据、理论和项目都要能服务某个仿真任务。</p></div>
