  ...
  return <Layout title="研究情报" description="每日研究动态与资料收集入口">
    <AeroLabFrame active="DISCOVER">
      ...
      <section className="lab-page-section">
        <div className="lab-page-head"><div><span>INTELLIGENCE WALL</span><h2>研究情报页先要像一面任务情报墙。</h2></div><p>资料入口不是普通新闻列表，而是从任务、工具、开源项目和数据来源中筛选值得继续研究的线索。</p></div>
      ...
      <section className="lab-page-section">
        <div className="lab-overlay-panel"><img src={labImages.control} alt="研究情报控制台"/><div><span>INTAKE OPERATIONS</span><h3>每天新增内容时，先进入情报流，不直接污染知识库。</h3><p>这个页面的设计重点是长期维护：快速接收资料、标记来源、判断价值、分配去向。稳定结论再进入知识库、项目雷达、数据方法或复现实验室。</p></div></div>
      </section>
      <section className="lab-page-section">
