...
const config = {
  ...
  themeConfig: {
    image: 'img/visual/hero-simulation-center.jpg',
    metadata: [{ name: 'keywords', content: '航天仿真, MATLAB, Simulink, Ansys STK, GMAT, Orekit, Tudat, Basilisk, CFD, GNC, 轨道力学, 复现实验' }, { name: 'theme-color', content: '#050916' }],
