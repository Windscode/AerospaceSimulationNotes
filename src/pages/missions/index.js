...
export default function MissionsPage(){
  return <Layout title="任务案例" description="火箭、轨道、月球、再入等航天仿真任务案例库">
    <AeroLabFrame active="MISSIONS">
      <LabPageHero eyebrow="MISSION DOSSIERS" title="MISSION CASES" text="任务案例是这个网站的研究主线：把火箭、航天器、轨道、再入、月面任务与工具链、公开数据、参数推断和复现实验连接起来。" image={labImages.hero} stats={[{label:'DOSSIERS', value:String(missionDossiers.length)}, {label:'DATA MODE', value:'OPEN + EST'}, {label:'TRACE', value:'REQUIRED'}]} />
      <section className="lab-page-section">
        <div className="lab-page-head"><div><span>MISSION INDEX</span><h2>用任务对象组织知识，而不是堆目录。</h2></div><p>每个任务档案都要回答：研究对象是什么，数据从哪里来，参数如何估计，工具怎么验证，结果如何复现。</p></div>
      ...
      <section className="lab-page-section">
        <div className="lab-page-head"><div><span>DATA & TOOLCHAIN</span><h2>每个案例都必须绑定数据来源和工具链。</h2></div><p>这能防止任务案例变成漂亮图片：所有结论必须能追溯到数据、假设、软件和验证结果。</p></div>
      ...
      <section className="lab-page-section">
        <div className="lab-page-head"><div><span>INFERENCE METHOD</span><h2>公开数据不足时，案例必须说明估计方法。</h2></div><p>你的网站特色不是“资料很多”，而是能诚实说明怎么从公开资料走到可运行的仿真参数。</p></div>
